...
<script type="text/javascript">
       $(document).ready(function() {
              $('#open').click(function() {
                     var url = '${pageContext.request.contextPath}/member_r_reservationStart.do?pNo=${requestScope.performance.pNo }";
...
<body>
       <div style="margin-left: 50px;">
              ...
              <!-- reservation -->
              <forEach var="performance" items="${requestScope.performance}"
                     varStatus="loop">
