...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#selectBtn').click(function(){	
			...
			var select = 'pNo=${param.pNo}&tNo=${param.tNo}&oNo=${param.oNo}&totalPrice=${param.totalPrice}&selectTd=${param.selectTd}&cardNumber='+$('#cardNumber').val()+'&cardCoNo=' +$('#cardCoNo').find('option:selected').val()+'&oTime=${param.oTime}'+'&title=${param.title}&sDate=${param.sDate}&rNo=${requestScope.reservation.rNo}';
